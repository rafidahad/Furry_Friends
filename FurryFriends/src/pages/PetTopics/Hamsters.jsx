...
const HamstersPosts = ({ toggleTheme, darkMode }) => {
  ...
  // Fetch posts tagged "Hamsters" and sort by likes descending
  useEffect(() => {
    const fetchHamstersPosts = async () => {
      try {
        const response = await api.get("/posts/tag/Hamsters");
        ...
        console.error("Error fetching hamsters posts:", error);
      }
    };
    fetchHamstersPosts();
  }, []);
