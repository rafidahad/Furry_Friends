...
const BirdsPosts = ({ toggleTheme, darkMode }) => {
  ...
  // Fetch posts tagged "Birds" and sort by likes descending
  useEffect(() => {
    const fetchBirdsPosts = async () => {
      try {
        const response = await api.get("/posts/tag/Birds");
        ...
        console.error("Error fetching birds posts:", error);
      }
    };
    fetchBirdsPosts();
  }, []);
