...
const RabbitsPosts = ({ toggleTheme, darkMode }) => {
  ...
  // Fetch posts tagged "Rabbits" and sort them by likes descending
  useEffect(() => {
    const fetchRabbitsPosts = async () => {
      try {
        const response = await api.get("/posts/tag/Rabbits");
        ...
        console.error("Error fetching rabbits posts:", error);
      }
    };
    fetchRabbitsPosts();
  }, []);
