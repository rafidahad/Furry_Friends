...
const FerretsPosts = ({ toggleTheme, darkMode }) => {
  ...
  // Fetch posts tagged "Ferrets" and sort by likes descending
  useEffect(() => {
    const fetchFerretsPosts = async () => {
      try {
        const response = await api.get("/posts/tag/Ferrets");
        ...
        console.error("Error fetching ferrets posts:", error);
      }
    };
    fetchFerretsPosts();
  }, []);
