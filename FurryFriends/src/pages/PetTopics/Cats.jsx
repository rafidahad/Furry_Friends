...
const CatsPosts = ({ toggleTheme, darkMode }) => {
  ...
  useEffect(() => {
    const fetchCatsPosts = async () => {
      try {
        const response = await api.get("/posts/tag/Cats");
