...
// 🔹 Destructure toggleTheme & darkMode from props
const Popular = ({ toggleTheme, darkMode }) => {
  ...
  // Fetch posts from /posts/random and sort by likes descending
  useEffect(() => {
  ...
  return (
    <Box sx={{ backgroundColor: theme.palette.background.default, minHeight: '100vh' }}>
      {/* Pass toggleTheme & darkMode to Navbar */}
      <Navbar 
